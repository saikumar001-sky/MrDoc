  ...
  <section class="flex">
    <div>
      <div class="container mb-4" id="auth-api">
        ...
        <p>The Authentication API provides endpoints to authenticate users and manage access tokens, ensuring secure access to your application. This section covers the details of the authentication process, including verifying tokens, adding users (senders), managing beneficiaries, and handling transactions.</p>
      </div>
      <section class="my-4" id="auth-endpoint">
        <h2 class="font-bold">Endpoint</h2>
        <p>This endpoint is used to authenticate a user. It requires valid user credentials and returns a JSON Web Token (JWT) upon successful authentication.</p>
        <div class="flex py-3 bg-slate-300 rounded-md">
          <div class="mx-3 bg-green-500 text-white px-3 py-1 font-bold">POST</div>
        ...
        <div class="overflow-auto text-sm md:text-base">
          <table class="border bg-white my-4 w-full text-left">
            ...
            <tr class="border">
              ...
              <td class="p-3 text-red-500">M</td>
              <td class="p-3">3/5</td>
              <td class="p-3">Defines the type of user (e.g., individual (IND), Business(BUS)).</td>
            </tr>
          </table>
        </div>
      </section>
      <section class="my-4" id="auth-sample-req">
        ...
        <p>Please Check below given sample Request data for the authenticate user api.</p>
        ...
        <div class="overflow-auto text-sm md:text-base">
          <table class="border bg-white my-4 w-full text-left">
            ...
            <tr class="border">
              ...
              <td class="p-3">Token for accessing secured resources. Null if not yet generated.</td>
            </tr>
            <tr class="border">
              <td class="p-3">refresh_token</td>
              <td class="p-3 text-green-500">O</td>
              <td class="p-3">36/36</td>
              <td class="p-3">Token for refreshing the access token. Null if not yet generated.</td>
            </tr>
            <tr class="border">
            ...
            <tr class="border">
              ...
              <td class="p-3 text-red-500">M</td>
              <td class="p-3">3/5</td>
              <td class="p-3">Defines the type of user (e.g., IND for Individual, BUS for Business).</td>
            </tr>
            <tr class="border">
              <td class="p-3">is_bus_created</td>
              <td class="p-3 text-green-500">O</td>
              <td class="p-3">N/A</td>
              <td class="p-3">Indicates if a business account has been created by the user.</td>
            </tr>
            <tr class="border">
              <td class="p-3">is_two_factor_auth</td>
              <td class="p-3 text-red-500">M</td>
              <td class="p-3">N/A</td>
              <td class="p-3">Indicates if two-factor authentication is enabled for the user.</td>
            </tr>
            <tr class="border">
              <td class="p-3">is_two_factor_check</td>
              <td class="p-3 text-green-500">O</td>
              <td class="p-3">N/A</td>
              <td class="p-3">Indicates if two-factor authentication is currently being checked.</td>
            </tr>
            <tr class="border">
              ...
              <td
                class="p-3"
              >Indicates if the user's KYC (Know Your Customer) verification is completed.</td>
            </tr>
            <tr class="border">
              <td class="p-3">is_mobile_verified</td>
              <td class="p-3 text-green-500">O</td>
              <td class="p-3">N/A</td>
              <td class="p-3">Indicates if the user's mobile number is verified.</td>
            </tr>
            <tr class="border">
              <td class="p-3">complete_registration</td>
              <td class="p-3 text-red-500">M</td>
              <td class="p-3">N/A</td>
              <td class="p-3">Indicates if the user has completed their registration process.</td>
            </tr>
            <tr class="border">
              <td class="p-3">kyc_status</td>
              <td class="p-3 text-green-500">O</td>
              <td class="p-3">8/10</td>
              <td class="p-3">Status of the user's KYC process (e.g., Approved, Pending).</td>
            </tr>
            <tr class="border">
            ...
            <tr class="border">
              ...
              <td class="p-3 text-red-500">M</td>
              <td class="p-3">N/A</td>
              <td class="p-3">Indicates if the user has access to the payment gateway.</td>
            </tr>
            <tr class="border">
              <td class="p-3">supported_payment_modes</td>
              <td class="p-3 text-red-500">M</td>
              <td class="p-3">5/100</td>
              <td class="p-3">List of payment modes supported (e.g., FPX, E-Wallets).</td>
            </tr>
            <tr class="border">
              <td class="p-3">is_self_beneficiary</td>
              <td class="p-3 text-green-500">O</td>
              <td class="p-3">N/A</td>
              <td class="p-3">Indicates if the user is the beneficiary of their own account.</td>
            </tr>
            <tr class="border">
              <td class="p-3">is_check_pin</td>
              <td class="p-3 text-green-500">O</td>
              <td class="p-3">N/A</td>
              <td class="p-3">Indicates if the user has enabled PIN verification.</td>
            </tr>
          </table>
        </div>
      </section>
      <section class="my-4" id="auth-sample-res">
        ...
        <p>Please Check below given sample response data for the authenticate user api.</p>
        ...
        <div class="overflow-auto text-sm md:text-base">
          <table class="border my-4 w-full text-left">
            ...
            <tr class="border">
              ...
              <td
                class="p-3"
              >OK - The request has succeeded, and the user is authenticated successfully.</td>
            </tr>
            <tr class="border">
              <td class="p-3 text-green-400 font-bold">201</td>
              <td class="p-3">Created - The user account has been created successfully.</td>
            </tr>
            <tr class="border">
